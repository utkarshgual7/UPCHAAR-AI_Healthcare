              ...
              handler: async (response) => {
                  ...
                  if (response.razorpay_payment_id) {
                      ...
                      const { data } = await axios.post(
                          ...
                          { 
                              firstName, lastName, email, phone, nic, dob, gender, appointmentDate, appointmentTime, department, doctor_firstName: doctorFirstName, doctor_lastName: doctorLastName, address, hasVisited: hasVisitedBool, height, weight, bloodType, allergies 
                          },
                          {
                              withCredentials: true,
                              mode: "cors",
        ...
        >
          ...
          <form onSubmit={handleAppointment}>
            ...
            <div className="mb-4">
              ...
              <textarea rows={10} placeholder='Address' value={address} onChange={(e) => setAddress(e.target.value)} ></textarea>
            </div>
